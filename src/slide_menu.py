...
class _ContentArea(ft.GridView):
	...
	def _on_scroll(self, event:  ft.OnScrollEvent):
		if event.event_type == 'end':
			...
			prev_pixels = new_frame*self._page.width
			self.update()
...
# 		stops=[0.0, 0.5, 1.0],
# 		colors=['#FFFFFFFF', '#EEF5F5FF', '#90DDDDFF']
# 	)
# 	menu = SlideNavigation(page=page, menu_gradient=gradient)
# 	for i in range(0, 3):
# 		src = f'https://raw.githubusercontent.com/Rekiro-0/flet-slide-menu/refs/heads/main/assets/backgrounds/{i}.jpg'
# 		image = ft.Image(
# 			src=src,
...
# 			bottom=0,
# 		)
# 		stack = ft.Stack(controls=[image])
# 		menu.add_frame(stack, src)
# 	page.add(menu)
